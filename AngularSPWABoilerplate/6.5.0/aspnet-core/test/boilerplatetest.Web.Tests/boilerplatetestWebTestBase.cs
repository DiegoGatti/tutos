...
{
    public abstract class boilerplatetestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static boilerplatetestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(boilerplatetestWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<boilerplatetestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<boilerplatetestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<boilerplatetestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<boilerplatetestDbContext, Task<T>> func)
        {
            T result;
