...
{
    public abstract class PruebaWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PruebaWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PruebaWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PruebaDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PruebaDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PruebaDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PruebaDbContext, Task<T>> func)
        {
            T result;
